...
// État pour le modal d'ajout de follower
const isAddFollowerModalOpen = ref(false)
...
<template>
          ...
          <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2 flex-1 ml-4">
              ...
              >
                <div class="flex items-center gap-1.5">
                  <UIcon
                    ...
                    class="w-3 h-3"
                  />
                  <span>{{ latestAudit.type === AuditType.INITIAL ? 'Initial' : latestAudit.type === AuditType.SURVEILLANCE ? 'Surveillance' : 'Renouvellement' }}</span>
                </div>
              </UBadge>
              ...
              >
                <div class="flex items-center gap-1.5">
                  <UIcon
                    :name="displayEntity.type === EntityType.GROUP ? 'i-lucide-layers' : 'i-lucide-building-2'"
                    class="w-3 h-3"
                  />
              ...
              >
                <div class="flex items-center gap-1.5">
                  <UIcon
                    :name="displayEntity.mode === EntityMode.MASTER ? 'i-lucide-star' : 'i-lucide-link'"
                    class="w-3 h-3"
                  />
        ...
        <div class="flex gap-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                  ...
                  <div class="flex items-start gap-2 text-sm">
                    ...
                    <div class="text-gray-700">
                      ...
                      <div v-if="displayEntity.addressComplement" class="text-gray-600">{{ displayEntity.addressComplement }}</div>
          ...
          >
            <div class="flex items-center justify-between mb-4">
              <div class="flex items-center gap-2">
                <UIcon
                  :name="displayEntity.type === EntityType.GROUP ? 'i-lucide-building-2' : 'i-lucide-network'"
              ...
              <UButton
                ...
                color="neutral"
                variant="ghost"
                @click="isAddFollowerModalOpen = true"
              />
            </div>

            <!-- Liste des entités liées -->
            <div v-if="(displayEntity.type === EntityType.GROUP && displayEntity.childEntities && displayEntity.childEntities.length > 0) || (displayEntity.type === EntityType.COMPANY && displayEntity.parentGroup)" class="space-y-1">
              ...
              <template v-else-if="displayEntity.parentGroup && displayEntity.parentGroup.mode === 'FOLLOWER'">
                ...
                >
                  ...
                  <span v-if="displayEntity.parentGroup.oe" class="text-xs text-gray-400 ml-auto">({{ displayEntity.parentGroup.oe.name }})</span>
                </a>
              </template>
            </div>
    ...
    <!-- Modal d'ajout d'entité suiveuse -->
    <AddFollowerModal
      v-if="displayEntity"
      v-model:open="isAddFollowerModalOpen"
      :entity-id="displayEntity.id"
