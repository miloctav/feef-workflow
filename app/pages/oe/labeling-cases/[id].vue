    ...
    <template #body>
              ...
              <div>
                ...
                <div class="space-y-3">
                  <div class="flex items-center gap-2">
                    ...
                    <NuxtLink :to="`/oe/companies/${company.id}`" class="text-gray-900 font-medium hover:text-primary hover:underline cursor-pointer">
      ...
      <div class="w-full px-6 mb-6">
        <UTabs :items="tabItems" default-value="documents" class="w-full" orientation="horizontal">
          <template #documents>
            <DocumentsTab :company="company" role="oe" />
          </template>
          
          <template #candidature>
            <CandidatureTab :company="company" role="oe"/>
          </template>
          
          <template #engagement>
            <EngagementTab :company="company" role="oe"/>
          </template>
          
          <template #audit>
            <AuditTab :company="company" role="oe"/>
          </template>
          
          <template #decision>
            <DecisionTab :company="company" role="oe" />
          </template>
        </UTabs>
      </div>
    </template>
