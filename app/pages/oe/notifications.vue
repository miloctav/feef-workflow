      ...
      <div class="p-6">
        ...
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-gray-600 mt-1">Suivez les événements importants de vos dossiers</p>
          </div>
...
function handleNotificationClick(notification: any) {
  ...
  if (notification.auditId) {
    router.push(`/oe/audits/${notification.auditId}`)
  } else if (notification.entityId) {
    router.push(`/oe/entities/${notification.entityId}`)
  }
}
</script>
