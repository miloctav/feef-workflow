 ...
 *
 * Met à jour les audits avec status=PLANNING vers PENDING_REPORT
...
export default defineTask({
  meta: {
    ...
    description: 'Met à jour les audits PLANNING → PENDING_REPORT quand actualEndDate est passée',
  },
  async run({ payload, context }) {
    ...
    console.log(`[TASK] Looking for audits with status=PLANNING and actualEndDate < ${today}`)
    ...
    try {
      ...
      // Trouver les audits à mettre à jour
