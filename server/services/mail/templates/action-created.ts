 ...
 * Envoyé lorsqu'une action est créée pour un utilisateur
 */
export const actionCreatedTemplate: EmailTemplate<ActionCreatedEmailData> = {
  type: 'action-created',

  getSubject: (data) => {
    return `Nouvelle action : ${data.actionTitle}`
  },
...
<head>
  ...
  <title>Nouvelle action - FEEF Workflow</title>
</head>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.6;">
                Une nouvelle action vous a été assignée sur <strong>FEEF Workflow</strong>.
              </p>
