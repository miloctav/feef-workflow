 ...
 * Envoyé lorsqu'un administrateur crée un compte pour un utilisateur
 */
export const accountCreationTemplate: EmailTemplate<AccountCreationEmailData> = {
  type: 'account-creation',

  getSubject: (data) => {
    return `Bienvenue sur FEEF Workflow - Créez votre mot de passe`
  },
...
<head>
  ...
  <title>Création de compte FEEF Workflow</title>
</head>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 30px 0 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                Ce lien est valable pendant <strong>${data.expiresInHours} heures</strong>. Si vous n'avez pas demandé la création de ce compte, vous pouvez ignorer cet email.
              </p>
