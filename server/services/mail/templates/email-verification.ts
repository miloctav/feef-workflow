 ...
 * Envoyé lorsqu'un utilisateur demande à changer son adresse email
 */
export const emailChangeVerificationTemplate: EmailTemplate<EmailChangeVerificationData> = {
  type: 'email-change-verification',

  getSubject: (data) => {
    return `Confirmez votre nouvelle adresse email - FEEF Workflow`
  },
...
<head>
  ...
  <title>Confirmation de changement d'email FEEF Workflow</title>
</head>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.6;">
                Vous avez demandé à changer votre adresse email sur <strong>FEEF Workflow</strong>.
              </p>

              <!-- Encadré avec les emails -->
              <div style="margin: 20px 0; padding: 20px; background-color: #f9fafb; border-left: 4px solid #3b82f6; border-radius: 4px;">
              ...
              <p style="margin: 30px 0 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                Ce lien est valable pendant <strong>${data.expiresInHours} heures</strong>. Si vous n'avez pas demandé ce changement, vous pouvez ignorer cet email en toute sécurité.
              </p>
              ...
              <div style="margin-top: 30px; padding-top: 30px; border-top: 1px solid #e5e7eb;">
                ...
                <p style="margin: 0; word-break: break-all;">
                  <a href="${data.verificationUrl}" style="color: #3b82f6; font-size: 13px; text-decoration: underline;">
